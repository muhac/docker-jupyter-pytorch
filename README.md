...
This docker configuration is Ubuntu 20.04 LTS, CUDA version 11.3, cuDNN 9. You may change the base system and the CUDA version listed here: [nvidia/cuda | DockerHub](https://hub.docker.com/r/nvidia/cuda/tags?page=1).
